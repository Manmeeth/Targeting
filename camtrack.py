...
while 1:
    ...
    delayTime = 100 #This delayTime is in Mili seconds, added this in the loop that captures frames. 
    #DelayTime=50 => fps = 1000/50 i.e 20. If DelayTime=100, fps => 1000/100 i.e 10.
